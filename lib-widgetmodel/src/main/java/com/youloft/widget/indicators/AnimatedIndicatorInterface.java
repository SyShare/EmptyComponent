...
public interface AnimatedIndicatorInterface {
     ...
     * @param endColor   end_color
     * @param isGradient support Gradient
     */
    void setGradient(int startColor, int endColor, boolean isGradient);
    ...
    /**
     * Can be called from DachshundTabLayout. Sets width of the indicator.
     *
     * @param width - width of the tab indicator.
     */
    void setSelectedTabIndicatorWidth(int width);
