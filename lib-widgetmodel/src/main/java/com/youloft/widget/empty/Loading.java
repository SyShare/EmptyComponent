...
import com.youloft.widget.empty.compat.UiCompat;
import com.youloft.widget.empty.drawable.LoadingCircleDrawable;
import com.youloft.widget.empty.drawable.LoadingDrawable;
import com.youloft.widget.empty.drawable.LoadingLineDrawable;
...
public class Loading extends View {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        // Load attributes
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Loading, defStyleAttr, 0);
